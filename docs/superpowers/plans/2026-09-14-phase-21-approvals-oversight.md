...
## Amendments made during execution (`D-1`…`D-10`, from the SDD ledger, 2026-09-14)
...
- **D-11+** — reserved for the final whole-branch review and its fix wave.
