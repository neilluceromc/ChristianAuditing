...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  headset: (<><polyline points="4,10 4,7 a5,5 0 0 1 10,0 v3" /><rect x="2.5" y="10" width="3" height="4" /><rect x="12.5" y="10" width="3" height="4" /></>),
  inventory: (<><rect x="3" y="5" width="12" height="10" /><polyline points="3,5 9,2.5 15,5" /><line x1="9" y1="8" x2="9" y2="12" /></>),
  employee: (<><circle cx="9" cy="6" r="3" /><polyline points="3.5,15.5 3.5,13 a5.5,4 0 0 1 11,0 v2.5" /></>),
