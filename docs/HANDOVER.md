...
4. **There is no next CODING task. Everything below is either a user decision or a physical act no
   ...
   **(m) PHASE 20 (IT side: department transfers, offboarding attribution and facets, directory quality,
   ...
   (`D-1`…`D-22`; `D-23+` reserved for the final whole-branch review) first, same rule as Phases 11–19.
   ...
   **21 migrations** · **1291 unit / 75 files** · **296 e2e / 27 files** by `--list`, across six foreground
   ...
   between any two chunks, or after the last, and no node process was left running. See plan `D-1`…`D-22`
...
9. **Running the e2e suite — 296 tests across 27 files, and the split below is MEASURED, not estimated.**
   ...
   **258 / 21 files, unchanged**, confirmed by `--list` after the final-review fix wave (2026-09-09,
   ...
   fixture needed to be the same class as the batch under test). See plan `D-1`…`D-22` and HANDOVER (m) for
   what each fix diagnosed). It
