...
1. **Phase 17 — the scale sweep — is DONE.** Code-complete on `phase-17-scale-sweep`, 2026-09-08
   ...
   `superpowers/plans/2026-09-08-phase-17-scale-sweep.md` (11 amendments, `D-1`…`D-11` — the final-review
   fix wave added `D-10`/`D-11`). What remains: the
