...
1. **Phase 30 — Laws of UX applied to the inventory area (the record's state-chosen primary with
   ...
   commits `a94f47a` and `b582535`. **Staging is NOT yet redeployed — that redeploy is the user's
   decision** — the phase adds **no migration** (26 stays), so it is a code-only
