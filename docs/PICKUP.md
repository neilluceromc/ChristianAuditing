...
1. **Phase 23 — Parkinson sweep: quick forms and complete-by dates — IS MERGED TO `main` via
   ...
   **Staging is NOT yet redeployed: migration 24 applies at the next `scripts/deploy-staging.ps1 -Force`, the user's decision, not pre-authorised.**
