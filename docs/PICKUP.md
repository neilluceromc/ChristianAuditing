...
1. **Phase 18 — Purchasing: suppliers and request extensions — is CODE-COMPLETE, including the
   final-review fix wave**, on `phase-18-purchasing-suppliers`, **UNMERGED and UNPUSHED at the time of
   writing**: a supplier master record (profile, contract, encrypted bank accounts, documents, search)
