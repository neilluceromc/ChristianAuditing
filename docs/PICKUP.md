...
| Database | **22 migrations** on `main` (merge `b716767`; migration 22 `approval_applied_directly`, additive, one-statement backfill; 21 `employee_transfers`, 20 `stock_control`); staging runs **22** too (the 2026-09-15 `-Force` redeploy applied 22; 20 and 21 came with the 2026-09-10 redeploy). `prisma migrate reset` is **not** used in this project. |
