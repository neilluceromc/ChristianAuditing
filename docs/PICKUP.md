...
| Battery, last run 2026-09-07 | `tsc` clean · `lint` clean · **993 unit / 54 files** · `npm run build` · `docker compose --profile prod build` · **213 e2e / 16 files** across five foreground chunks — 31 · 67 · 46 · 36 · 33. Commands and history: `HANDOVER.md` §0 item 9. |
